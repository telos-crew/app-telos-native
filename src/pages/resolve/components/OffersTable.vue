	...
	data() {
		return {
			...
			columns: [
				{
					name: 'status',
					label: this.$t('pages.resolve.offers_table_status'),
					field: 'status'
				},
				{
				...
				{
					name: 'hourly_rate',
					label: this.$t('pages.resolve.offers_table_rate'),
					field: 'hourly_rate'
				},
				{
					name: 'total',
					label: this.$t('pages.resolve.offers_table_total'),
					field: 'total'
				},
				{
					name: 'actions',
					label: this.$t('pages.resolve.offers_table_actions'),
					field: 'actions'
				}
			]
		}
