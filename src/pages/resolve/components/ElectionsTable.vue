				...
				<template v-slot:body="props">
					<q-tr :props="props">
						...
						<q-td
							...
							class="default"
						>
							<span>{{ $t('pages.resolve.elections_table_seats') }}</span
							><br />
						...
						<q-td
							...
							class="default"
						>
							<span>{{ $t('pages.resolve.elections_table_end_add') }}</span
							><br />
						...
						>
							<span>
								{{ $t('pages.resolve.elections_table_end_voting') }} </span
							><br />
	...
	data() {
		return {
			columns: [
				{
					name: 'election_id',
					label: this.$t('pages.resolve.elections_table_id'),
					field: 'election_id'
				},
				{
					name: 'ballot_name',
				...
				{
					name: 'status',
					label: this.$t('pages.resolve.elections_table_status'),
					field: 'status'
				}
			],
			expandedRows: [],
