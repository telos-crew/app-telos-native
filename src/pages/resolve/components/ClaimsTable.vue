	...
	>
		...
		<template v-slot:body-cell-claim_summary="props">
			<q-td :props="props">
				...
				>
					<q-tooltip>{{
						$t('pages.resolve.claims_table_more_info_claimant')
					}}</q-tooltip>
				</q-badge>
			</q-td>
		</template>
		...
		<template v-slot:body-cell-response_link="props">
			<q-td :props="props">
				...
				>
					<q-tooltip>{{
						$t('pages.resolve.claims_table_more_info_respondant')
					}}</q-tooltip>
				</q-badge>
			</q-td>
		</template>
		...
		<template v-slot:body-cell-actions="props">
			<q-td :props="props">
				<q-btn-dropdown
					color="primary"
					:label="$t('pages.resolve.claims_table_actions')"
				>
					<q-list>
						<q-item
							v-if="
						...
						>
							<q-item-section>
								<q-item-label>{{
									$t('pages.resolve.claims_table_respond_cta')
								}}</q-item-label>
							</q-item-section>
						</q-item>
						<q-item
						...
						>
							<q-item-section>
								<q-item-label>{{
									$t('pages.resolve.claims_table_request_more')
								}}</q-item-label>
							</q-item-section>
						</q-item>
						<q-item
						...
						>
							<q-item-section>
								<q-item-label>{{
									$t('pages.resolve.claims_table_settle_cta')
								}}</q-item-label>
							</q-item-section>
						</q-item>
					</q-list>
	...
	data() {
		return {
			...
			columns: [
				...
				{
					name: 'status',
					label: this.$t('pages.resolve.claims_table_status'),
					field: 'status'
				},
				{
					name: 'actions',
					label: this.$t('pages.resolve.claims_table_actions_column'),
					field: 'actions'
				}
			]
		}
