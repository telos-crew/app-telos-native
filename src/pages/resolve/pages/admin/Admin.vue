		...
		<div class="q-pa-md stepper-wrap">
			...
			>
				...
				>
					...
					<i18n-t
						keypath="pages.resolve.admin_step_case_content_2"
						tag="p"
					>
				...
				<q-step
					:name="'voting'"
					:title="$t('pages.resolve.admin_step_voting')"
					icon="add_comment"
				>
				...
				>
					<i18n-t
						keypath="pages.resolve.admin_step_election_finalization_content"
					>
