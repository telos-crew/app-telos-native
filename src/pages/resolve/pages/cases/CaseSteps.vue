	...
	<div id="#resolve-case-steps">
		<div class="q-pa-md stepper-wrap">
			...
			>
				<q-step
					:name="0"
					:title="$t('pages.resolve.case_steps_setup_title')"
					icon="settings"
				>
				...
				<q-step
					:name="3"
					:title="$t('pages.resolve.case_steps_investigation_title')"
					icon="add_comment"
				>
				...
				<q-step
					:name="4"
					:title="$t('pages.resolve.case_steps_decision_title')"
					icon="add_comment"
				>
				...
				<q-step
					:name="5"
					:title="$t('pages.resolve.case_steps_enforce_title')"
					icon="add_comment"
				>
				...
				<q-step
					:name="6"
					:title="$t('pages.resolve.case_steps_case_closed')"
					icon="add_comment"
				>
				</q-step>
			</q-stepper>
